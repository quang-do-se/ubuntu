...
** Install GNU Emacs
   ...
   #+begin_src shell
     ...
     sudo apt-get install build-essential texinfo libx11-dev libxpm-dev libjpeg-dev libpng-dev libgif-dev libtiff-dev libncurses-dev libgtk-3-dev libgnutls28-dev automake autoconf
