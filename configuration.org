...
** Install GNU Emacs
   ...
   #+begin_src shell
     ...
     sudo apt install -y build-essential texinfo libx11-dev libxpm-dev libjpeg-dev libpng-dev libgif-dev libtiff-dev libncurses-dev libxpm-dev libgtk-3-dev libgnutls28-dev automake autoconf
     ...
     wget https://ftp.gnu.org/pub/gnu/emacs/emacs-29.4.tar.gz
